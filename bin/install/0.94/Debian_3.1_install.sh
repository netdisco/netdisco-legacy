...
echo ""
echo "     This script will install Netdisco on a stock Debian"
...
echo "    second time during the installation of the perl modules, just reply 'no'."
echo ""
echo ""
...
echo "    The apxs (or apxs2) binary is located in /usr/bin/."
echo ""
echo ""
...
#
NETDISCO='http://superb-east.dl.sourceforge.net/sourceforge/netdisco/netdisco-0.94_with_mibs.tar.gz'
...
echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo ""
apt-get install -y apache2 apache2-prefork-dev postgresql postgresql-dev postgresql-client libperl5.8 libperl-dev libelfsh0-dev beecrypt2-dev snmp snmpd libsnmp-perl libapache-mod-ssl libgraphviz-perl
...
#
# Edit Apache Config
echo "LoadModule perl_module /usr/lib/apache2/modules/mod_perl.so" >> /etc/apache2/apache2.conf 
echo "LoadModule apreq_module /usr/lib/apache2/modules/mod_apreq2.so" >> /etc/apache2/apache2.conf 
