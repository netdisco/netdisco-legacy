...
echo ""
echo "     This script will install Netdisco on a stock Fedora Core 5"
...
echo "    of apxs.  On Fedora Core 5 - both the httpd and apxs binaries are located in /usr/sbin."
echo ""
echo ""
...
#
FRESHRPMS='http://ftp.freshrpms.net/pub/freshrpms/fedora/linux/5/freshrpms-release/freshrpms-release-1.1-1.fc.noarch.rpm'
