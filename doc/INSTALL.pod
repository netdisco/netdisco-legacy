...
Originally created by Max Baker.  See list at the end of README of all the
contributors.
...
Make sure that something similar to the following C<LoadModule>
commands are in your F<httpd.conf> or F<netdisco_apache.conf>:
