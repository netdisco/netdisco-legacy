...
1.16 or newer required.  1.26 or newer advised.

=item * Apache

1.3.x advised, B<Version 2.x not yet supported by mod_perl>
...
Version 0.16 or higher recommended.
