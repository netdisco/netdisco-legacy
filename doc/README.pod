...
contributions to Netdisco :  
    ...
    Mark Boolootian (UCSC), Jim Warner (UCSC), Remo Rickli (PSI, Switzerland),  Mike Hunter (UCB),
    Brian Wilson (NCSU), David Temkin (sig.com), Edson Manners (FSU), Jean-Philippe Luiggi (sagem.com),
    Kismet Developers AP List, A.L.M Buxey (Loughborough University, UK)
