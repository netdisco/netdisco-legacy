...
Netdisco is hosted by Source Forge and lives at L<http://www.netdisco.org>.

=head1 FEATURES - OVERVIEW
...
The outgoing port belongs to the device listed above the C<list:> line.
