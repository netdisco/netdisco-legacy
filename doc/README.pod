...
B<WARNING>!  A security hole is opened by Netdisco as it tries to auto-discover
...
Therefore B<YOU MUST> disable CDP and similar discovery protocols from your
end-ports!  Leave CDP/LLDP support enabled on all your uplink ports.

  TODO: Sample IOS code to do the above here.
...
Walk the network with the given root.  Use L<-N|/item__2dn__7c_7c__2d_2dnewonly> to discover new devices only.  Given root device
